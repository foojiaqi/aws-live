...
def AddEmp():
    if request.method=='POST':
        ...
        try:
            ...
            cursor.execute(insert_sql, (emp_id, first_name, last_name, pri_skill, location,emp_image_file,leave_start_date,leave_end_date,leave_reason,leave_status,job_title,gender,date_of_hired))
            db_conn.commit()
